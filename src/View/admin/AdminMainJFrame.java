...
import View.admin.panel.FirstMenuPanel;
import Util.CSSTool;
import Util.View.AdminJFrame;
...
public class AdminMainJFrame extends AdminJFrame implements AdminJFrameConfig{
    private final MyRenderingPanel rp;                         //右栏渲染面板
