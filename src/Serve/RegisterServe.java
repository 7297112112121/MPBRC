...
import DAO.register.AdminRegister;
import Object.Admin;
...
public class RegisterServe implements PasswordConfig {
    ...
    public static void register(Admin admin) {
        //写入数据库
        boolean follow = AdminRegister.register(admin);
        if (follow) {
    ...
    public static String sendYangZhenMa(int time, JButton button) {
        ...
        //向用户手机发送短信
        RouterForm.getMobileRouterServe().sendMessage("【验证码】您的验证码是："+ number +"，请勿泄露给他人。如非本人操作，请忽略此短信。");
