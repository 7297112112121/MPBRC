...
import DAO.register.UserRegister;
...
import Object.User;
import Util.erro.*;
import Util.PhoneCountdown;

import javax.swing.*;

import static data.UserForm.loadNewUsers;
import static Config.PasswordConfig.*;

public class UserRegisterServe {
    private static Logger logger = LogManager.getLogger(UserRegisterServe.class);
    ...
    public static void register(String name, String phone, String password) throws UserObjectException {
        ...
        //访问数据访问层
        boolean flas = UserRegister.register(user);
        if (!flas) {
