 ...
 * 注册业务
 * */
public class AdminRegister implements Register{
    private static final Logger logger = LogManager.getLogger(AdminRegister.class);
    /**
     * 执行用户注册，主要处理注册异常
     * 默认注册失败，返回false
     * */
    public  boolean register(Object obj) throws AdminObjectException {
        try {
            boolean fals = false;
